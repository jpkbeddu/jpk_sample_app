...
# => :name validity
	...
	describe "when the name exceeds 50 characters" do
...
# => :email uniqueness and case-insensitivity (Test is not at all failing)
...
# => Checking for password mismatch
	describe "when password mismatches with the confirmation" do
